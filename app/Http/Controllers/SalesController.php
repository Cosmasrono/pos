...
class SalesController extends Controller
{
    ...
    {
        $products = Product::where('is_active', true)
            ->select('id', 'name', 'sku', 'barcode', 'selling_price as price', 'quantity_in_stock as stock')
            ->orderBy('name')
            ->get();
    ...
    public function searchProduct(Request $request): JsonResponse
    {
        ...
        $products = Product::where('is_active', true)
            ...
            ->select('id', 'name', 'sku as code', 'barcode', 'selling_price as price', 'quantity_in_stock as stock')
            ->orderBy('name')
            ->take(20)
            ->get();
