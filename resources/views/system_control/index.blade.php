                ...
                <div class="modal-content text-start">
                    ...
                    <form action="{{ route('system.toggle') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <p>You are about to deactivate the system. This will log out all other users. Please enter the security password to confirm.</p>
                            <div class="form-group mb-0">
                                <label for="system_password_sc_deactivate" class="form-label fw-bold">Enter Deactivation Password</label>
                                <input type="password" name="system_password" id="system_password_sc_deactivate" class="form-control" placeholder="Enter password" required>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content text-start">
                    ...
                    <form action="{{ route('system.toggle') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <p>You are about to activate the system. All users will regain access. Please enter the security password to confirm.</p>
                            <div class="form-group mb-0">
                                <label for="system_password_sc_activate" class="form-label fw-bold">Enter Activation Password</label>
                                <input type="password" name="system_password" id="system_password_sc_activate" class="form-control" placeholder="Enter password" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="mb-0 text-muted">
                            ...
                            <li>Your account (owner@wingpos.com) bypasses all restrictions.</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="mb-0 text-muted">
